...
with c4:
    ...
    high_risk = sum(1 for w in wl_data if w.get("risk_level", "").lower() == "high")
...
with col_brief:
    ...
    if briefing and briefing.get("briefing_content"):
        ...
        st.info("이번 주 브리핑이 아직 생성되지 않았습니다.")
...
with col_chart:
    ...
    fda_data = fetch_fda_483(limit=50)
...
c1, c2 = st.columns(2)
with c1:
    wl_data = fetch_warning_letters(limit=100)
